    ...
    <div className={styles.carouselSlideDiv}>
      <div className={styles.carouselSlideInfoDiv}>
        ...
        <p className="font-regular">
          ...
          години на учесниците и колку талентирани и предани луѓе има.Прашањата
          беа многу предизвикувачки, но истовремено и интересни. Беше потребно
          да се замислам длабоко и да применувам напредни математички концепти и
          техники за да ги решам.
        </p>
      </div>
